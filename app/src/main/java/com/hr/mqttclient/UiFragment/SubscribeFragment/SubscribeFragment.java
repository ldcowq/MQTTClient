package com.hr.mqttclient.UiFragment.SubscribeFragment;
...
import com.hr.mqttclient.R;

import org.eclipse.paho.client.mqttv3.MqttException;

import static com.hr.mqttclient.MainActivity.handler;
import static com.hr.mqttclient.MainActivity.mqttClient;
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    ...
                    try {
                        ...
                        subscribe_status_show_textView.setText("已连接！");
                    } catch (MqttException e) {
                        e.printStackTrace();
                    }
                }
